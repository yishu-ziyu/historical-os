          ...
          options: [
            {
              ...
              description: '等待更多信息，不主动干预当前分支。',
              riskCost: 0,
              intelReturn: 'low',
              unlocksNodes: [],
              consequencePreview: '安全但异常在自行演化',
              estimatedDrift: { turnDelta: 0, totalDelta: 0.1, domains: ['world_stability'], reason: '无干预，世界线自然漂移' },
            },
            {
              id: 'action-investigate',
              label: '主动调查',
              icon: 'magnifying-glass',
              historicalPlausibility: 'medium',
              description: '投入情报资源深挖异常锚点的真实影响。',
              riskCost: 1,
              intelReturn: 'high',
              unlocksNodes: ['node-deep-investigation'],
              consequencePreview: '可能暴露干预痕迹，但获得关键情报',
              estimatedDrift: { turnDelta: 0.3, totalDelta: 0.6, domains: ['academic_circles', 'resistance_network'], reason: '主动调查会加速因果扩散' },
            },
            {
              id: 'action-intervene',
              label: '施加干预',
              icon: 'hand',
              historicalPlausibility: 'low',
              description: '直接介入历史节点，尝试改变事件走向。',
              riskCost: 2,
              intelReturn: 'medium',
              unlocksNodes: ['node-intervention-point'],
              consequencePreview: '高风险：直接改变历史节点可能触发连锁反应',
              estimatedDrift: { turnDelta: 0.8, totalDelta: 1.5, domains: ['einstein_fate', 'scientific_exodus', 'war_escalation'], reason: '直接干预历史节点会引发大幅度世界线偏移' },
            },
          ],
